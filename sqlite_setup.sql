-- Yabatech JSS Management System — SQLite Schema
-- Adapted from supabase_setup.sql (PostgreSQL)
-- Changes:
--   SERIAL PRIMARY KEY  →  INTEGER PRIMARY KEY AUTOINCREMENT
--   NUMERIC             →  REAL
--   TIMESTAMP DEFAULT … →  TEXT DEFAULT (datetime('now'))
--   DATE DEFAULT …      →  TEXT DEFAULT (date('now'))
--   REFERENCES syntax kept (enforced via PRAGMA foreign_keys=ON in db_manager.py)
